...
class _$_Count with DiagnosticableTreeMixin implements _Count {
  const _$_Count({required this.dateTime, required this.count});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Count(dateTime: $dateTime, count: $count)';
  }
...
abstract class _Count implements Count {
  const factory _Count(
      {required final DateTime dateTime, required final int count}) = _$_Count;
